...
# 4. Посчитаем количество комбинаций после удаления деблей.
# 5. Найдём вероятность перейти реку по частотному определению вероятности: (число комбинаций мостов, когда можно перейти реку) / (число всех комбинаций мостов).
